        ...
        <div className="max-w mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {projects.map((project, i) => (
              <div
                key={i}
                className="bg-white/5 backdrop-blur-md rounded-xl p-6 text-left shadow-xl hover:shadow-purple-500/30 hover:scale-105 transition-transform duration-300 liquid-glass"
              >
                <Image
                  alt="Dashboard"
                  width={500}
